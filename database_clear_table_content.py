...
TABLES_TO_CLEAR = ['goals', 'cards', 'matchdays', 'matchday_summary', 'matches', 'community_predictions', 'referees', 'm_competitions', 'matchday_info', 'm_teams', 'league_table', 'match_teams', 'lineups', 'players', 'match_lineups', 'substitutions', 'top_scorers']
