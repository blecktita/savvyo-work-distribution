...
class NavigationManager:
    ...
    def __init__(self, logger_name: str = "NavigationManager"):
        ...
        self.config = NavigationConfig.from_constants(
            HTMLConstants, 
            ScrapingConstants
        )
    ...
    def navigate_to_next_page(self, driver, vpn_handler=None) -> bool:
        ...
        try:
            ...
            print(f"Current URL: {self.url_parser.truncate_url_for_display(current_url)}")
            ...
            print(f"Navigating to page {next_page_num}: {self.url_parser.truncate_url_for_display(next_url)}")
            ...
            if new_url != current_url:
                print(f"Successfully navigated to: {self.url_parser.truncate_url_for_display(new_url)}")
                return True
            else:
    ...
    def _find_next_page_url(
        ...
        return self.url_parser.construct_next_page_url(
            current_url, 
            next_page_num
        )