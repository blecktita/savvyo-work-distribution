...
from configurations import get_config, ScraperConfig
...
class RotationMonitor:
    ...
    def verify_ip_rotation(self, expected_new_ip: Optional[str] = None, max_retries: int = 3) -> bool:
        """
        Verify IP rotation
        """
    ...
    def get_status(self) -> Dict:
        ...
        if self.last_rotation_time:
            time_since_seconds = (datetime.now() - self.last_rotation_time).total_seconds()
        else:
