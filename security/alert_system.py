...
from .models import SecurityAlert, SecurityThreatLevel, IPRotationEvent
...
class AlertSystem:
    ...
    def send_alert(
        ...
        if (self.email_config and 
            threat_level in [SecurityThreatLevel.HIGH, SecurityThreatLevel.CRITICAL]):
    ...
    def _send_email_alert(self, alert: SecurityAlert, rotation_history: List[IPRotationEvent]) -> None:
        """
    ...
    def _format_email_body(self, alert: SecurityAlert, rotation_history: List[IPRotationEvent]) -> str:
        """
