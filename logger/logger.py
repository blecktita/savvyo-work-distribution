...
def demo_rotation_strategies():
    ...
    daily_logger = setup_daily_rotating_logger(
        "DailyApp", "logs/daily_app.log", days_to_keep=30
    )
    ...
    session_logger = setup_session_based_logger("scraper", "logs")
    ...
    smart_logger = setup_smart_logger(
        "SmartApp", "logs/smart_app.log", strategy="daily", days_to_keep=7
    )
