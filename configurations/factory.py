...
class ConfigFactory:
    ...
    @staticmethod
    def custom(environment: str = "development",
               max_pages: int = 10,
               use_vpn: bool = True,
               requests_per_rotation: int = 10,
               database_url: Optional[str] = None,
               **kwargs) -> ScraperConfig:
        """
    ...
    @staticmethod 
    def for_colleague(colleague_name: str, 
                     host_ip: str,
                     assigned_continents: Optional[List[str]] = None,
                     environment: str = "production") -> ScraperConfig:
        """
...
def get_colleague_config(colleague_name: str, 
                        host_ip: str,
                        continents: Optional[List[str]] = None) -> ScraperConfig:
    """
