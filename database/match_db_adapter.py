...
from extractors.extractor_matchday import Card as DataclassCard
from extractors.extractor_matchday import Goal as DataclassGoal
from extractors.extractor_matchday import MatchdayContainer, MatchDetail
from extractors.extractor_matchday import Player as DataclassPlayer
from extractors.extractor_matchday import Substitution as DataclassSubstitution
from extractors.extractor_matchday import Team as DataclassTeam

from .schemas import Card, Goal, Match, MatchdayInfo, MatchLineup, Player, Substitution
...
class MatchDataConverter:
    ...
    def convert_and_save_match(self, match_detail: MatchDetail) -> bool:
        ...
        try:
            ...
            existing_match = (
                ...
                .filter(Match.match_id == match.match_id)
                .first()
            )
    ...
    def _update_match_fields(self, existing_match: Match, new_match: Match):
        ...
        update_fields = [
            ...
            "away_ht_score",
            "match_report_url",
            "source_url",  # FIXED: Add missing URL fields
            "extraction_metadata",
        ]
    ...
    def _save_match_events(self, match_detail: MatchDetail, is_update: bool = False):
        ...
        for sub_data in match_detail.substitutions:
            substitution = self._create_substitution(
                match_detail.match_info.match_id, sub_data
            )
            if substitution:
    ...
    def _create_substitution(
        self, match_id: str, sub_data: DataclassSubstitution
    ...
    def create_matchday_info(
        self, matchday_container: MatchdayContainer
